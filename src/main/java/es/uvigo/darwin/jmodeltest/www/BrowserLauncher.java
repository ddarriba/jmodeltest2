package es.uvigo.darwin.jmodeltest.www;
 ...
 *  etc. -- but that has not been rigorously tested and is not guaranteed to work. <p>
 *
...
public class BrowserLauncher {
	...
	private final static String JDirect_MacOSX = "/System/Library/Frameworks/Carbon.framework/Frameworks/HIToolbox.framework/HIToolbox";

	/**  JVM constant for MRJ 2.0 */
	private final static int MRJ_2_0 = 0;

	/**  JVM constant for MRJ 2.1 or later */
	private final static int MRJ_2_1 = 1;

	/**  JVM constant for Java on Mac OS X 10.0 (MRJ 3.0) */
	private final static int MRJ_3_0 = 3;

	/**  JVM constant for MRJ 3.1 */
	private final static int MRJ_3_1 = 4;
	 ...
	 *  properly.
	 */
	private final static String FINDER_TYPE = "FNDR";

	/**  The creator code of the Finder on a Macintosh, which is needed to send AppleEvents to the application.  */
	private final static String FINDER_CREATOR = "MACS";

	/**  The name for the AppleEvent type corresponding to a GetURL event. */
	private final static String GURL_EVENT = "GURL";
	 ...
	 *      browser; instead, it's the application that gets called to open the default web browser. In some cases, this
	 *      will be a non-String object that provides the means of calling the default browser.
	 */
	 ...
	 *
	 * @param  instance        Description of Parameter
	 * @param  hint            Description of Parameter
	 * @param  data            Description of Parameter
	 * @param  len             Description of Parameter
	 * @param  selectionStart  Description of Parameter
	 * @param  selectionEnd    Description of Parameter
	 * @return                 Description of the Returned Value
	 */
