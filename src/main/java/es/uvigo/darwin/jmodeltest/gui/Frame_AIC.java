...
public class Frame_AIC extends JModelTestFrame {
    ...
    public void RunButtonAICActionPerformed(java.awt.event.ActionEvent e) {
            ...
            try {
                    ...
                    if (checkBoxAICc.isSelected()) {
                            myAICc = new AICc(writePAUPblock, doImportances, doModelAveraging, credibleInterval, modelTest);
                            myAICc.compute();
                            ...
                            myAIC = new AIC(writePAUPblock, doImportances, doModelAveraging, credibleInterval, modelTest);
                            myAIC.compute();
