 ...
 *
 * Title:			jModelTest
 * Description:		Java extended version of Modeltest for the selection of substitution nucleotide models
 * @author			David Posada			
 * @version			
 */
...
public class Frame_hLRT extends JModelTestFrame {
	...
	public void initComponents() throws Exception {
		...
		CancelButtonhLRT.setLocation(new java.awt.Point(160, 220));
