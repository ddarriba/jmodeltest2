...
public class Frame_CalcLike extends JModelTestFrame 
{
	...
	public void initComponents() throws Exception {
        ...
        PanelNumberModelsCalcLike.setBorder(new BorderUIResource.TitledBorderUIResource(
        										new LineBorder(XManager.PANEL_BORDER_COLOR, 1, false),
        ...
        PanelFrequenciesCalcLike.setBorder(new BorderUIResource.TitledBorderUIResource(
        ...
        TextFieldNcat.setToolTipText("Number of rate categories for the discrete gamma distribution");
        ...
        ButtonGroupTreeOptimizationCalcLike.add(ButtonFixedUserTopologyCalcLike);
	...
	public void RunButtonCalcLikeActionPerformed(ActionEvent e) 
	{
        try 
        {
            ...
            progressFrame = new Frame_Progress(options.getNumModels(), this, modelTest);
	...
	{
        FileDialog fc = new FileDialog(this, "Load Newick tree file with branch lengths", FileDialog.LOAD);
        ...
        if (treefilename != null) // menu not canceled
        {
            ...
            modelTest.getMainConsole().print("Reading tree file \"" + treefilename + "\"...");
