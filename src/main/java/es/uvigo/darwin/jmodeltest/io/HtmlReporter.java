...
public abstract class HtmlReporter {
	...
	public static void buildReport(ApplicationOptions options, Model models[]) {
		...
		datamodel.put("doAveragedPhylogeny", options.doAveragedPhylogeny?new Integer(1):new Integer(0));
	...
	static void freemarkerDo(Map<String,Object> datamodel, String template) throws Exception
	{
		...
		for (String file : TEMPLATE_FILES) {
			...
			if (!auxFile.exists()) {
				File inFile = new File(resourcesDir.getPath() + File.separator + file);
				if (inFile.exists()) {
...
//		File outputFile = File.createTempFile(logDir.getPath() + File.separator + "jmodeltest-log-", "html");
	...
	private static void fillInWithOptions(ApplicationOptions options) {
		...
		for (String argument : ModelTest.arguments) arguments.append(argument + " ");
		...
		if (options.countBLasParameters) optimizedParameters.append("+ " + options.numBranches + " branch lengths ");
		if (options.optimizeMLTopology) optimizedParameters.append("+ topology");
		...
		if (options.fixedTopology) datamodel.put("baseTree", "Fixed BioNJ");
		else if (options.optimizeMLTopology) datamodel.put("baseTree", "Maximum Likelihood");
		...
		} else datamodel.put("baseTree", "BioNJ");
		...
		datamodel.put("confidenceInterval", String.format("%5.2f", options.confidenceInterval * 100));
	}
	...
	private static void fillInWithSortedModels(Model[] models){
		...
		for (Model model : models) {
			...
			modelMap.put("fA", model.ispF()?String.format("%5.4f", model.getfA()):"-");
			modelMap.put("fC", model.ispF()?String.format("%5.4f", model.getfC()):"-");
			modelMap.put("fG", model.ispF()?String.format("%5.4f", model.getfG()):"-");
			modelMap.put("fT", model.ispF()?String.format("%5.4f", model.getfT()):"-");
			modelMap.put("titv", model.ispT()?String.format("%5.4f", model.getTitv()):"-");
			modelMap.put("rA", model.ispR()?String.format("%5.4f", model.getRa()):"-");
			modelMap.put("rB", model.ispR()?String.format("%5.4f", model.getRb()):"-");
			modelMap.put("rC", model.ispR()?String.format("%5.4f", model.getRc()):"-");
			modelMap.put("rD", model.ispR()?String.format("%5.4f", model.getRd()):"-");
			modelMap.put("rE", model.ispR()?String.format("%5.4f", model.getRe()):"-");
			modelMap.put("rF", model.ispR()?String.format("%5.4f", model.getRf()):"-");
			modelMap.put("pInv", model.ispI()?String.format("%5.4f", model.getPinv()):"-");
			modelMap.put("shape", model.ispG()?String.format("%6.4f", model.getShape()):"-");
	...
	private static void fillInWIthInformationCriterion(InformationCriterion ic, Collection<Map<String, String>> sortedModels, Map<String, String> bestModel) {
		...
		bestModel.put("fA", model.ispF()?String.format("%5.4f", model.getfA()):"-");
		bestModel.put("fC", model.ispF()?String.format("%5.4f", model.getfC()):"-");
		bestModel.put("fG", model.ispF()?String.format("%5.4f", model.getfG()):"-");
		bestModel.put("fT", model.ispF()?String.format("%5.4f", model.getfT()):"-");
		bestModel.put("titv", model.ispT()?String.format("%5.4f", model.getTitv()):"-");
		bestModel.put("rA", model.ispR()?String.format("%5.4f", model.getRa()):"-");
		bestModel.put("rB", model.ispR()?String.format("%5.4f", model.getRb()):"-");
		bestModel.put("rC", model.ispR()?String.format("%5.4f", model.getRc()):"-");
		bestModel.put("rD", model.ispR()?String.format("%5.4f", model.getRd()):"-");
		bestModel.put("rE", model.ispR()?String.format("%5.4f", model.getRe()):"-");
		bestModel.put("rF", model.ispR()?String.format("%5.4f", model.getRf()):"-");
		bestModel.put("pInv", model.ispI()?String.format("%5.4f", model.getPinv()):"-");
		bestModel.put("shape", model.ispG()?String.format("%6.4f", model.getShape()):"-");
		...
		bestModel.put("cumWeight", String.format("%5.4f", ic.getCumWeight(model)));
		...
		for (int i = 1; i < ic.getNumModels(); i++) {
			...
			modelMap.put("cumWeight", String.format("%5.4f", ic.getCumWeight(model)));
