...
public class RFHistogram {
	...
	private static JFreeChart buildHistogram(double[] values, int steps, String plotTitle, String xAxis, String yAxis) 
	{
		...
		JFreeChart chart = ChartFactory.createHistogram(plotTitle, xAxis, yAxis, hds, orientation, show, toolTips, urls);
	...
	public static JFreeChart buildDistancesHistogram(InformationCriterion ic, TreeDistancesCache distances, String plotTitle) 
	{
		...
		JFreeChart chart = buildHistogram(values, steps, plotTitle, xaxis, yaxis);
	...
	{
		return buildDistancesHistogram(ic, TreeRFDistancesCache.getInstance(), ic + " RF distances histogram");
	}
	
	public static JFreeChart buildEuclideanHistogram(InformationCriterion ic) 
	{
		return buildDistancesHistogram(ic, TreeEuclideanDistancesCache.getInstance(), ic + " euclidean distances histogram");
	}
	...
	public static JFreeChart buildRandomHistogram() 
	{
		...
		String xaxis = "number";
		String yaxis = "value";
		JFreeChart chart = buildHistogram(value, number, plotTitle, xaxis, yaxis);
		return chart;
	}
}