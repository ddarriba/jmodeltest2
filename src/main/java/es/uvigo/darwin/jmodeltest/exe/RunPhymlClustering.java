...
public class RunPhymlClustering extends RunPhyml 
{
	...
	public RunPhymlClustering(Observer progress, ModelTest modelTest, Model[] models) 
	{
	...
	protected Object doPhyml() 
	{
		...
		for (int groups=6; groups>0; groups--) 
		{
			...
			Model[] currentModels = GuidedSearchManager.getModelsSubset(models, partition, groups, modelTest);
			...
			if (currentModels.length > 0) 
			{
				...
				{
					PhymlSingleModel phymlModel = new PhymlSingleModel(model, 0, false, false, options);
